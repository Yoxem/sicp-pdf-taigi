#import "@preview/min-book:1.3.0": annexes, book

#set text(lang: "en", region: "TW")
...
阮beh研究*計算過程*ê概念。計算過程是電腦會當紡ê抽象事物。
過程進行時會操作另一種號作*資料*ê抽象ê概念。
過程ê進行由一樣號作*程式*，有模式ê一組規則指引。
人建立程式來指引過程。
其實，咱用咒語召喚電腦ê神魂。

A computational process is indeed much like a sorcerer's idea of a spirit. It cannot be seen or touched. It is not composed of matter at all. However, it is very real. It can perform intellectual work. It can answer questions. It can affect the world by disbursing money at a bank or by controlling a robot arm in a factory. The programs we use to conjure processes are like a sorcerer's spells. They are carefully composed from symbolic expressions in arcane and esoteric programming languages that prescribe the tasks we want our processes to perform.

計算過程確實足像 sorcerer 講ê神魂。
它看無亦摸無，根本毋是由物質所構成。
不過它非常真實。
它會當行智力ê工課，會當回答問題，亦會當透過佇銀行提款抑是控制工廠內ê機械來影響世界。
阮召喚過程ê程式著像 sorcerer ê咒語。
由神秘深奧的程式語言中ê符號表達精心編寫所成，遮ê言語規定咱希望過程執行ê任務。
...
#footnote[The Lisp 1 Programmer's Manual appeared in 1960, and the Lisp 1.5 Programmer's Manual (McCarthy 1965) was published in 1962. The early history of Lisp is described in McCarthy 1978.]
...
#footnote[One such special application was a breakthrough computation of scientific importance -- an integration of the motion of the Solar System that extended previous results by nearly two orders of magnitude, and demonstrated that the dynamics of the Solar System is chaotic. This computation was made possible by new integration algorithms, a special-purpose compiler, and a special-purpose computer all implemented with the aid of software tools written in Lisp (Abelson et al. 1992; Sussman and Wisdom 1992).]
